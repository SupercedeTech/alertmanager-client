...
-- | display the config
instance P.Show AlertmanagerClientConfig where
  show c =
    T.printf
...
-- | constructs a default AlertmanagerClientConfig
--
-- configHost:
--
-- @http://localhost@
...
-- configUserAgent:
--
-- @"alertmanager-openapi/0.0.1.0"@
--
newConfig :: IO AlertmanagerClientConfig
newConfig = do
    logCxt <- initLogContext
    return $ AlertmanagerClientConfig
        { configHost = "http://localhost"
        , configUserAgent = "alertmanager-openapi/0.0.1.0"
...
addAuthMethod config@AlertmanagerClientConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: AlertmanagerClientConfig -> IO AlertmanagerClientConfig
...
withStderrLogging :: AlertmanagerClientConfig -> IO AlertmanagerClientConfig
...
data AlertmanagerRequest req contentType res accept = AlertmanagerRequest
  { rMethod  :: NH.Method   -- ^ Method of AlertmanagerRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of AlertmanagerRequest
  , rParams   :: Params -- ^ params of AlertmanagerRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (AlertmanagerRequest req contentType res accept) NH.Method
rMethodL f AlertmanagerRequest{..} = (\rMethod -> AlertmanagerRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (AlertmanagerRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f AlertmanagerRequest{..} = (\rUrlPath -> AlertmanagerRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (AlertmanagerRequest req contentType res accept) Params
rParamsL f AlertmanagerRequest{..} = (\rParams -> AlertmanagerRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (AlertmanagerRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f AlertmanagerRequest{..} = (\rAuthTypes -> AlertmanagerRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => AlertmanagerRequest req contentType res accept -> param -> AlertmanagerRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: AlertmanagerRequest req contentType res accept -> param -> AlertmanagerRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: AlertmanagerRequest req contentType res accept -> param -> AlertmanagerRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
setHeader ::
     AlertmanagerRequest req contentType res accept
  -> [NH.Header]
  -> AlertmanagerRequest req contentType res accept
...
removeHeader :: AlertmanagerRequest req contentType res accept -> [NH.HeaderName] -> AlertmanagerRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> AlertmanagerRequest req contentType res accept
    -> IO (AlertmanagerRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> AlertmanagerClientConfig
  -> IO (AlertmanagerRequest req contentType res accept)
_applyAuthMethods req config@(AlertmanagerClientConfig {configAuthMethods = as}) =
  foldlM go req as
  where
